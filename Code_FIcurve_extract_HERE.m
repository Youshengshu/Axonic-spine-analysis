clear all;clc
Fidx{1}=dir('2021.01.20_P63_MALE_iLS_S2C1_COULD use_100-400_1_Regular W C.mat');
%Fidx{2}=dir('LL*.mat');
...
%         Vposi(spkFreq~=0)=nan;
        ...
        % PC PV protocol
        StimAmp(StimAmp<200)=round(StimAmp(StimAmp<200)/30)*30;%StimAmp(StimAmp<200)=round(StimAmp(StimAmp<200)/10)*10;
