...
epsp_ParamName={'cell','un_Amp', 'un_Area', 'un_DecayTime'};

save('GroupName',...
    'epsp_paramRecord',...
     'epsp_ParamName','FilenameRecord')
%for kk=1:length(fidx)
    xlswrite('Results_2_photo_post.xls',FilenameRecord,['epsp_Param_',GroupName{1}],'A2')
    xlswrite('Results_2_photo_post.xls',epsp_ParamName,['epsp_Param_',GroupName{1}],'A1')
    xlswrite('Results_2_photo_post.xls',[epsp_paramRecord{1}(1,:)',...
                                             epsp_paramRecord{2}(1,:)'],['epsp_Param_',GroupName{1}],'B2')
